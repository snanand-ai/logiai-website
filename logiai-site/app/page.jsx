  ...
  <div className="mx-auto max-w-6xl px-6 py-24">
    <div className="flex flex-col items-center text-center">
      ...
      <img
        src="/logo.png"
        alt="LogiAI"
        className="h-36 md:h-44 mb-6"
      />

      {/* Tagline */}
      <p className="text-sm tracking-wide text-slate-500 mb-10">
        Flow Forward
      </p>
      ...
      <p className="mt-6 max-w-3xl text-lg text-slate-600">
        ...
        complexity, and guides humans to better decisions before any action is taken.
      </p>
